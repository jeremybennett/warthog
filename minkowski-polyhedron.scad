...
module fuse_sect () {
   intersection () {
	 ...
	 translate (v = [-500, -500, 0])
	    cube (size = [1000, 1000, 220], center = false);
      }
      if (SECOND_SECT) {
	 translate (v = [-500, -500, 220])
	    cube (size = [1000, 1000, 220], center = false);
      }
      if (THIRD_SECT) {
	 translate (v = [-500, -500, 440])
	 cube (size = [1000, 1000, 220], center = false);
      }
      if (FOURTH_SECT) {
	 translate (v = [-500, -500, 660])
	    cube (size = [1000, 1000, 220], center = false);
      }
   }
}
...
module pegs () {
   if (FIRST_SECT) {
      translate (v = [-6, 10, 209.5])
         cylinder (r = 4.8, h = 20, center = false);
      translate (v = [38, 10, 209.5])
         cylinder (r = 4.8, h = 20, center = false);
   }
   if (SECOND_SECT) {
      translate (v = [-6, 12, 429.5])
         cylinder (r = 4.8, h = 20, center = false);
      translate (v = [38, 12, 429.5])
         cylinder (r = 4.8, h = 20, center = false);
   }
   if (THIRD_SECT) {
      translate (v = [-6, 12, 649.5])
         cylinder (r = 4.8, h = 20, center = false);
      translate (v = [38, 12, 649.5])
         cylinder (r = 4.8, h = 20, center = false);
   }
}
...
module holes () {
   if (SECOND_SECT) {
      translate (v = [-6, 10, 210.5])
         cylinder (r = 5, h = 20, center = false);
      translate (v = [38, 10, 210.5])
         cylinder (r = 5, h = 20, center = false);
      }
   if (THIRD_SECT) {
      translate (v = [-6, 10, 430.5])
         cylinder (r = 5, h = 20, center = false);
      translate (v = [38, 10, 430.5])
         cylinder (r = 5, h = 20, center = false);
      }
   if (FOURTH_SECT) {
      translate (v = [-6, 10, 650.5])
         cylinder (r = 5, h = 20, center = false);
      translate (v = [38, 10, 650.5])
         cylinder (r = 5, h = 20, center = false);
      }
}
